...
import com.bjtu.airport.exception.CustomException;
import com.bjtu.airport.utils.JWTToken;
import com.bjtu.airport.vo.ResultVo;
...
//            message = URLEncoder.encode(message, "UTF-8");
    ...
    private void responseError(ServletRequest request, ServletResponse response) {
        ...
        try {
            ...
            out.print(new ObjectMapper().writeValueAsString(ResultVo.error(ResultCode.UNAUTHENTICATED)));
            out.flush();
        } catch (Exception e) {
            e.printStackTrace();
        } finally {
